...
```{r Transforming Categorical Variables, echo=FALSE, warning=FALSE}
original <- EDA_data %>% 
...
```{r Log-scaling Numerical Variables, echo=FALSE, warning=FALSE}
original <- EDA_data %>% 
...
```{r Z-score Scaling Numerical Variables, echo=FALSE, warning=FALSE}
original <- EDA_data %>% 
  ggplot(aes(dti)) +
  geom_histogram()
...
```{r Clipping Numerical Variables, echo=FALSE, warning=FALSE}
original <- EDA_data %>% 

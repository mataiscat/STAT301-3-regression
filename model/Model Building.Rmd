...
mod1 <- lm(money_made_inv ~ out_prncp_inv + loan_amnt + term + day_diff, data = train_num_data)
summary(mod1)

pred_probs1 <- predict(mod1, test_num_data)
err <- sqrt(mean((pred_probs1 - test_num_labels)^2))
